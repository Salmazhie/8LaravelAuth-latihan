        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav flex-row flex-wrap">
                    ...
                    <li class="nav-item col-2 col-md-auto"><a href="{{ route('employee.index') }}" class="nav-link">Employee List</a></li>
                </ul>
                ...
                <div class="p-5 bg-light rounded-3 col-xl-6">
                    ...
                    <div class="row">
                        <div class="col-md-6 d-grid">
                            <a href="{{ route('employee.index') }}" class="btn btn-outline-dark btn-lg mt-3"><i class="bi-arrow-left-circle me-2"></i> Cancel</a>
                        </div>
                        <div class="col-md-6 d-grid">
