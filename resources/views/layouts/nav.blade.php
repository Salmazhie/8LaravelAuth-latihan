    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav flex-row flex-wrap">
                ...
                <li class="nav-item col-2 col-md-auto"><a href="{{ route('employee.index') }}" class="nav-link @if($currentRouteName == 'employees.index') active @endif">Employee</a></li>
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <a href="{{ route('profile') }}" class="btn btn-outline-light my-2 ms-md-auto active">My Profile</a>
